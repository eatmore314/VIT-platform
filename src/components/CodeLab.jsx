    ...
    <div className="h-screen w-full font-sans">
      ...
      <div className="flex justify-between items-center p-3 bg-[#121212] text-white shadow">
        ...
        <div className="space-x-2">
          ...
          <button onClick={runCode} className="bg-green-600 hover:bg-green-700 px-3 py-1 rounded">
            Run
          </button>
          <button
            onClick={resetCode}
          ...
          <button onClick={saveLocal} className="bg-blue-600 hover:bg-blue-700 px-3 py-1 rounded">
            Save Local
          </button>
        </div>
      </div>
